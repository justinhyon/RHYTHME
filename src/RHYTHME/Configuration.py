...
TrigChan = 'create'  # python begins numbering from 0, so this is the channel number of the stim channel - 1 (not the name)
...
start_zero = False  # whether the experiment must start from the first sample (empty buffer), or False for the current
